...
<div class="content-academic-presentations">
  ...
  <div class="presentation-item">
    ...
    <details>
      <summary>
        Summary | <a style="color: #003d90" href="{{ '/files/slides/slides_mg_coloquio_2025.pdf' | relative_url }}" target="_blank">Slides</a>| <a style="color: #003d90" href="{{ '/files/slides/slides_mg_coloquio_2025.pdf' | relative_url }}" target="_blank">Certificate</a> | <a style="color: #003d90" href="{{ '/files/slides/slides_mg_coloquio_2025.pdf' | relative_url }}" target="_blank">Pictures</a>
      </summary>
      <p>
